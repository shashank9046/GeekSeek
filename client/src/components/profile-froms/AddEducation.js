        ...
        you have attended
            ...
            <form class="form" onSubmit={e => {
                ...
                <div class="form-group">
                    <input type="text" placeholder="* college" name="college" value={college} onChange={e => onChange(e)} required />
                </div>
                <div class="form-group">
                    <input type="text" placeholder="* B.Tech M.Tech BCA" name="branch" value={branch} onChange={e => onChange(e)} required />
                </div>
                <div class="form-group">
